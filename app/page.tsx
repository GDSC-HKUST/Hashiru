          ...
          <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div className="mr-auto place-self-center lg:col-span-7">
              <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl">
                Organize industry-leading hackathons in no time
              </h1>
              <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
                Make your hackathon planning and execution more efficient and
                effective, and unlock your participants{"'"} creativity with
                Hashiru, an all-in-one platform designed specifically for
                hackathons that provides a powerful suite of tools and features.
              </p>
              <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                ...
                <a
                  href="#"
                  className="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-200:ring-gray-700:text-white:bg-gray-700"
                >
                  <svg
            ...
            <div className="hidden bg-red-800 rounded-lg lg:mt-0 lg:col-span-5 lg:flex"></div>
          </div>
        </section>
        {/* End block */}
        {/* Start block */}
        <section className="bg-white">
          <div className="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
            <div className="grid grid-cols-2 gap-8 sm:gap-12 sm:grid-cols-3">
              <a
                href="#"
                className="flex items-center text-gray-500 lg:justify-center"
              >
                <svg
                  className="h-9 hover:text-gray-900:text-white"
                  viewBox="0 0 86 29"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              >
                <svg
                  className="h-8 hover:text-gray-900:text-white"
                  viewBox="0 0 151 34"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
              <div className="text-gray-500 sm:text-lg">
                ...
                <p className="mb-8 font-light lg:text-xl">
                  Organize top-notch hackathons with our intuitive feature-rich
                  platform in no time, without the complexity of traditional
                  solutions.
                </p>
                {/* List */}
                <ul
                ...
                >
                  <li className="flex space-x-3">
                    {/* Icon */}
                    <CheckCircleIcon className="flex-shrink-0 w-5 h-5 text-red-500" />
              ...
              <img
                className="hidden w-full h-full mb-4 bg-red-800 rounded-lg lg:mb-0 lg:flex"
          ...
          <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            <div className="col-span-2 mb-8">
              ...
              <h2 className="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
                Trusted by over 100,000 users and 20 large organizations
              </h2>
              ...
              <div className="pt-6 mt-6 space-y-4 border-t border-gray-200">
                <div>
                  <a
                    href="#"
                    className="inline-flex items-center text-base font-medium text-red-600 hover:text-red-800:text-red-700"
                  >
                    Explore IP Protection Guidelines
                    <svg
            ...
            <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
              <div>
                <ServerStackIcon className="w-10 h-10 mb-2 text-red-600 md:w-12 md:h-12" />
              ...
              <div>
                <UsersIcon className="w-10 h-10 mb-2 text-red-600 md:w-12 md:h-12" />
                <h3 className="mb-2 text-2xl font-bold">100K+ Users</h3>
                <p className="font-light text-gray-500">
                  Trusted by over 100,000 users around the world
                </p>
              </div>
              <div>
                <GlobeAsiaAustraliaIcon className="w-10 h-10 mb-2 text-red-600 md:w-12 md:h-12" />
                <h3 className="mb-2 text-2xl font-bold">100+ countries</h3>
                <p className="font-light text-gray-500">
                  Participants from over 100 countries has participated in a
                  hackathon hosted on Hashiru
                </p>
              </div>
              <div>
                <DocumentDuplicateIcon className="w-10 h-10 mb-2 text-red-600 md:w-12 md:h-12" />
                <h3 className="mb-2 text-2xl font-bold">20,000+ Submissions</h3>
                <p className="font-light text-gray-500">
                  Had been submitted on Hashiru
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gray-50">
          <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <figure className="max-w-screen-md mx-auto">
              ...
              <EnvelopeIcon className="h-12 mx-auto mb-3 text-gray-400" />
              <blockquote>
                <p className="text-xl font-medium text-gray-900 md:text-2xl">
                  As an organizer, I{"'"}ve used several hackathon platforms in
                  the past, but Hashiru is by far the best one I{"'"}ve come
                  across. It{"'"}s intuitive, easy to use, and has all the
                  features you need to run a successful hackathon. Our
                  participants were able to come up with some highly innovative
                  amazing projects too. Highly recommended!
                </p>
              </blockquote>
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                ...
                <div className="flex items-center divide-x-2 divide-gray-500">
                  ...
                  <div className="pl-3 text-sm font-light text-gray-500">
                    CEO at{" "}
                    <a
                      href="https://cloud.googleblog.com/2011/04/contoso-has-gone-google.html"
                      className=""
                    >
                      Contoso
                    </a>
          ...
          <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
              ...
              <p className="mb-5 font-light text-gray-500 sm:text-xl">
                Here at Hashiru, we focus on markets where technology,
            ...
            <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
              {/* Pricing Card */}
              <div className="flex flex-col w-full p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow sm:max-w-lg xl:p-8">
                <h3 className="mb-4 text-2xl font-semibold">Starter</h3>
                <p className="font-light text-gray-500 sm:text-lg">
                  Best option for small organizations.
                </p>
                ...
                <a
                  href="#"
                  className="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center:ring-red-900"
                >
                  Get started
                </a>
              </div>
              ...
              <div className="flex flex-col w-full p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow sm:max-w-lg xl:p-8">
                ...
                <p className="font-light text-gray-500 sm:text-lg">
                  Perfect for all types of companies with extended support.
                </p>
                <div className="flex items-baseline justify-center my-8">
              ...
              <div className="flex flex-col w-full p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow sm:max-w-lg xl:p-8">
                ...
                <p className="font-light text-gray-500 sm:text-lg">
                  Best for large scale organizations with extended support.
                </p>
                <div className="flex items-baseline justify-center my-8">
          ...
          <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div className="max-w-screen-sm mx-auto text-center">
              ...
              <p className="mb-6 font-light text-gray-500 md:text-lg">
                Try Hashiru Platform for 30 days. No credit card required.
              </p>
              <a
                href="#"
                className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2:bg-red-700 focus:outline-none:ring-red-800"
              >
